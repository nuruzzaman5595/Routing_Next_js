...
export default function Home() {
  return (
     <div className="min-h-screen flex items-center justify-center bg-gray-700 text-white">
        ...
        <p className="text-gray-300">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolor quaerat temporibus ea? Eum quo eaque maiores ex repudiandae nostrum odit.</p>
     </div>
  );
}
